...
if(outer_first == T){
  ...
  Features_out = bind_rows(Features_out, F1)
}
...
# write.table(Features_out, "Figures/Figure_4_new//Features_validModels.tsv", sep = "\t", col.names = T, row.names = F, quote = F)
# write.table(Features_out, "Results/Features_validModels.tsv", sep = "\t", col.names = T, row.names = F, quote = F)
# 
